#ifndef WAVEVM_NODE_RUNTIME_DIRECTORY_STORE_H
#define WAVEVM_NODE_RUNTIME_DIRECTORY_STORE_H
...
#define WVM_DIRECTORY_STORE_BUCKETS 4096U

struct wvm_directory_store_config {
...
struct wvm_directory_store {
    struct wvm_directory_store_config config;
    struct wvm_directory_page **buckets;
...
#endif /* WAVEVM_NODE_RUNTIME_DIRECTORY_STORE_H */
